...
# Run Command:
# PYTHONHASHSEED=1 torchrun --standalone --nnodes=1 --nproc_per_node=8 main_launch.py
# CUDA_VISIBLE_DEVICES=0,1 OMP_NUM_THREADS=1 PYTHONHASHSEED=1 torchrun --rdzv_backend=c10d --rdzv_endpoint=localhost:29400 --nnodes=1 --nproc_per_node=2 main_launch.py
...
parser = argparse.ArgumentParser(description='Speed Check for the PyTorch Distributed Training Package (Elastic Torch)')
# For ImageNet only
