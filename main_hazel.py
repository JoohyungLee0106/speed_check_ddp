...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        t = time.time()
        # train for one epoch
        train(train_loader, model, criterion, optimizer, epoch, scaler, scheduler, args)
        t1 = time.time()
...
def train(train_loader, model, criterion, optimizer, epoch, scaler, scheduler, args):
